                ...
                <div className="wisdom-tea__wrapper">
                    ...
                    <div className="wisdom-tea__block">
                        ...
                        <div className="wisdom-tea__button-container">
                            <button className={`wisdom-tea__btn ${isActive ? 'active' : 'inactive'}`} onClick={() => handleButtonClick('УСПІХ')}>УСПІХ</button>
                            <button className={`wisdom-tea__btn ${isActive ? 'active' : 'inactive'}`} onClick={() => handleButtonClick('МОТИВАЦІЯ')}>МОТИВАЦІЯ</button>
                            <button className={`wisdom-tea__btn ${isActive ? 'active' : 'inactive'}`} onClick={() => handleButtonClick('САМОПІЗНАННЯ')}>САМОПІЗНАННЯ</button>
                            <button className={`wisdom-tea__btn ${isActive ? 'active' : 'inactive'}`} onClick={() => handleButtonClick('СТОСУНКИ')}>СТОСУНКИ</button>
                            <button className={`wisdom-tea__btn ${isActive ? 'active' : 'inactive'}`} onClick={() => handleButtonClick('ТРУДНОЩІ')}>ТРУДНОЩІ</button>
                        </div>
                    </div>
                </div>
